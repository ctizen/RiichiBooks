...
{\footnotesize \textit{Note:} These graphs show the hand-performance statistics reported in a table on the ranking page (\textbf{https://bit.ly/2H0AF7V}) as of 20 December, 2015.}
\end{figure}
